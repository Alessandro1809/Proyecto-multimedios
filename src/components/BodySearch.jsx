   ...
   <div className="p-4 mt-4 pb-10">
       <div className="lg:hidden justify-end w-full md:hidden sm:flex flex items-center">
               <input id="search"
                type="text"
                pattern='[A-Za-z]'
                className=" bg-gray-50 rounded-full p-2 hover:bg-white shadow-inner shadow-orange-400 w-full h-10 placeholder:text-sm placeholder:text-center outline-none" placeholder="Filter by category"/>
