  ...
  return (
   ...
   <div className="p-4 mt-4 pb-10">
       <div className="lg:hidden justify-end w-full md:hidden sm:flex flex items-center">
               <input type="text" className=" bg-gray-50 rounded-full p-2 hover:bg-white shadow-inner shadow-orange-400 w-full h-8 placeholder:text-sm placeholder:text-center outline-none" placeholder="Search recipes"/>
